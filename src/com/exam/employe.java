    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
         ...
         try{
          Class.forName("com.mysql.jdbc.Driver");
          Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/my_bank","root",Admin_Pannel.rpass);
          PreparedStatement pstmt=con.prepareStatement("UPDATE employee SET em_name=?,father=?,mother=?,gender=?,mobile=?,email=?,address=?,digisnation=?,salary=? WHERE em_id=?");
          ...
          pstmt.setInt(9,sal);
          pstmt.setString(10, tf_id.getText());
